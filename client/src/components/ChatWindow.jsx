...
export default function ChatWindow({
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <h1 style={{ color: '#F8FAFC', fontSize: 20, fontWeight: 700, margin: 0, letterSpacing: '-0.02em' }}>
            Kyron Medical
          </h1>
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                height: 38,
                borderRadius: '50%',
                background: inputValue.trim() && !isLoading ? '#3B82F6' : 'rgba(255,255,255,0.1)',
                border: 'none',
            ...
            >
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                <path d="M2 8h12M8 2l6 6-6 6" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </button>
          </form>
